---
description: Explicit slash-command entrypoint to the pr-review:review skill. Same behavior as auto-trigger — gathers ticket context + review rules, asks how to surface findings, then runs the bundled pinned code-review workflow inline. Use this when you want to invoke review through the / menu instead of natural language.
allowed-tools: Skill, AskUserQuestion, Bash(gh:*), Bash(python3:*), Bash(rm:*), Read, Write, mcp__github_inline_comment__create_inline_comment
---
